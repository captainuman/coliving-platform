...
const fetchHotels = async () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-10 pb-10 space-y-5">
  ...
  >
    <div className="grid lg:grid-cols-12">
      ...
      <div className="lg:col-span-6 p-6">
        <h2 className="text-[20px] font-black mb-2">
        ...
        <p className="text-[14px] mb-4">
          ...
          <span className="text-gray-800">
            {" "}
            | {property.property?.address?.district || "Nearby city centre"}
          </span>
        </p>

        <div className="flex gap-10">
          <span className="border border-gray-400 px-3 py-1 rounded-md text-[12px] font-semibold text-gray-600">
        ...
        <div className="flex flex-wrap gap-2 mt-5">
          {property.property?.amenities?.slice(0, 4).map((item, index) => (
            <span
              key={index}
      ...
      {/* PRICE */}
      <div className="lg:col-span-3 border-l border-gray-300 p-6 flex flex-col justify-between text-right">
        <div>
        ...
        <button
          ...
          className="text-blue-600 text-[16px] font-medium text-end"
        >
          Book Now & Pay Later!
        </button>
      </div>
